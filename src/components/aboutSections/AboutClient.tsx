    ...
    return(
        <>
            <main>
                <Layout>
                    <AnimatedSection>
                        <div className="flex flex-col md:flex-row items-center gap-8 w-full pt-20 md:pt-40 mb-16">
                            <div className="relative group">
                                ...
                                <span className="absolute bottom-2 right-2 h-3 w-3 md:h-4 md:w-4 rounded-full bg-green-500 ring-2 ring-white dark:ring-gray-900"></span>
                            </div>
                            <div className="text-center md:text-left">
                                <h1 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 via-purple-700 to-blue-600 dark:from-white dark:via-purple-200 dark:to-blue-200 bg-clip-text text-transparent">KOUADIO ABEL BEKANTIE</h1>
